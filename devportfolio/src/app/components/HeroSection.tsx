        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <h1
              ...
              <span className="block text-foreground">Alex</span>
              <span className="block text-gradient-lime">Rivera.</span>
              <span
            ...
            <p className="animate-fade-in-up delay-200 text-base text-muted-foreground max-w-xl leading-relaxed border-l-2 border-primary pl-5 mb-10 font-normal">
              I craft fast, accessible, and beautiful web experiences. Passionate about React ecosystems, performance optimization, and the intersection of design and AI-driven interfaces.
            </p>
            ...
            <div
              ...
              style={{ animationDelay: `${400 + i * 100}ms` }}>
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  <Icon name="ChevronUpIcon" size={14} className="text-primary opacity-60 group-hover:opacity-100 transition-opacity" />
                </div>
